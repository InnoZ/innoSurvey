...
# CREATE ROLES
role_1 = survey.roles.create(name: 'Nutzer')
role_2 = survey.roles.create(name: 'Politik & Planung')
role_3 = survey.roles.create(name: 'Fahrzeughersteller & Flottenbetreiber')
role_4 = survey.roles.create(name: 'Mobilitätsdienstanbieter')
role_5 = survey.roles.create(name: 'Flow Management in den Bereichen Energie und Verkehr')
