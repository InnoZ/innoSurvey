...
# TOPICS
autonomer_iov_topic_1 = autonomer_iov.topics.create(id: 37, name: autonomer_iov.name, description: 'Fragen zum autonomen IÖV')
platforms_topic_1 = platforms.topics.create(id: 38, name: platforms.name, description: 'Fragen zu Platforms')
ai_topic_1 = ai.topics.create(id: 39, name: ai.name, description: 'Fragen zum AI Supported Flow Management')
multimodal_priv_topic_1 = multimodal_priv.topics.create(id: 40, name: multimodal_priv.name, description: 'Fragen zu Multimodal Privacy')
